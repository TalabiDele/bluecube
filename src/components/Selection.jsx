...
const Selection = () => {
	return (
		<div className=' max-md:w-[80vw] max-sm:w-[80vw] max-[360px]:w-[70vw] overflow-x-scroll no-scrollbar'>
			<div className='   rounded-md text-gray-500 grid grid-cols-7 shrink-0 justify-center mt-[2rem] w-[80%] max-lg:w-[70vw] max-xl:w-[70vw] relative max-sm:left-[1rem] max-md:w-[30rem] overflow-x-scroll no-scrollbar'>
